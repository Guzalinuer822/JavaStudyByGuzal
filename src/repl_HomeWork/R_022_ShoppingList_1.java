/*
		 ...
		 * prices. You will use Scanner object and ask user to enter 3 items followed by
...
public class R_022_ShoppingList_1 {
	...
	public static void main(String[] args) {
		...
		// System.out.println("I will learn "+"\""+lan1+"\" and \""+lan2+"\" at
		// CybertekSchool.");
