...
previous steps again. If no, print shopping list report and total price 
...
public class R_095_Shopping_list_2_repeatedEx {
	...
	public static void main(String[] args) {
		...
		// 1.ask use to enter items followed by its price
				...
				// to not show last comma ,because last two character is--- ", " --- one comma
				// and one space

				shoppingListReport = shoppingListReport.substring(0, shoppingListReport.length() - 2);

				// 2.print shopping list and total price
