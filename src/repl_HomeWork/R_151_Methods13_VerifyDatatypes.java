...
determine which primitive data types are capable of properly storing 
that input. Please complete an implementation of this method.



For each input variable  and appropriate primitive , you must determine 
...
own line and order them by size (i.e.: ).
byte < short < int < long
 ...
 */
public class R_151_Methods13_VerifyDatatypes {
