...
the hamletQuote method only returns true if one of  or both 
of the boolean parameters is true.
...
hint: use the truth table for this one, this can be done with 
one if and a logical operator.


 */
public class R_160_MethodsWithReturn5_hamletLogic {
