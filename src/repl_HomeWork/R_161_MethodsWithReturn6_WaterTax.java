...
The more water you use the more it will cost you (as a fine 
for wasting water).
...
and above 150 its the same as above 50 (units *0.90) but with a 
100 fine added to the price .




 */
public class R_161_MethodsWithReturn6_WaterTax {
